...
describe ArticulosController do
  ...
  let(:valid_attributes) { { "codigo" => "MyString", :tipo_de_envase_id => 1 } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved articulo as @articulo" do
        ...
        post :create, {:articulo => { "codigo" => "invalid value" }}, valid_session
        assigns(:articulo).should be_a_new(Articulo)
      end
      ...
      it "re-renders the 'new' template" do
        # Trigger the behavior that occurs when invalid params are submitted
        Articulo.any_instance.stub(:save).and_return(false)
        Articulo.any_instance.stub(:errors).and_return('anything')
        post :create, {:articulo => { "codigo" => "invalid value" }}, valid_session
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested articulo" do
        ...
        Articulo.any_instance.should_receive(:update_attributes).with({ "codigo" => "MyString" })
        put :update, {:id => articulo.to_param, :articulo => { "codigo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the articulo as @articulo" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Articulo.any_instance.stub(:save).and_return(false)
        put :update, {:id => articulo.to_param, :articulo => { "codigo" => "invalid value" }}, valid_session
        assigns(:articulo).should eq(articulo)
      end
